...
/**
 * @deprecated Use useTableSettings from @/components/ppdo/odpp/data-tables/core/hooks instead
 * This wrapper is maintained for backward compatibility with breakdown components.
 */

"use client";

import { useTableSettings as useGenericTableSettings } from "@/components/ppdo/odpp/utilities/data-tables/core/hooks/useTableSettings";
