...
import {
  ...
  getMaxTableWidth,
} from '@/components/ppdo/odpp/utilities/table/print-preview/table-resize/constants';
import {
  ResizingColumnState,
  ResizingRowState,
  HoveredHandle,
...
} from '@/components/ppdo/odpp/utilities/table/print-preview/table-resize/types';
