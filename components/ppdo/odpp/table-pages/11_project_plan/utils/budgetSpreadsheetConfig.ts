 ...
 * 
 * Before: import { BUDGET_SPREADSHEET_CONFIG } from "../utils/budgetSpreadsheetConfig";
 * After:  import { BUDGET_SPREADSHEET_CONFIG } from "@/components/ppdo/odpp/common/utils";
 */

export {
    BUDGET_SPREADSHEET_CONFIG,
    BUDGET_ITEM_COLUMNS,
} from "@/components/ppdo/odpp/utilities/common/utils/spreadsheetConfig";
