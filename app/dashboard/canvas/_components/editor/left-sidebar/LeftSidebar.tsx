// app/dashboard/canvas/_components/editor/left-sidebar/LeftSidebar.tsx
...
export default function LeftSidebar({
  ...
  return (
   <div className="flex flex-col w-64 h-[50%] bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 overflow-hidden">
